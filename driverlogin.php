...
<head>
    ...
    <title>Driver Log In Page</title>
                ...
                <div class="login-page">
                    ...
                    <div class="login-box">
                        <div class="block-title" >
                            <h2 class="title" style="color:#78b144;"><span>Driver Login</span></h2>
                        </div>

                        <form action="driverlogindata.php" onsubmit="return isValid()" method="POST" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Email</label>
                                <input type="email" value="" name="driveremail" id="driveremail" >
                            </div>
                            ...
                            <div class="form-group text-center">
                                <input type="submit" class="btn btn-primary" value="LOG IN" name="submit" style="background-color:#78b144;">
                            </div>
                            <div class="form-group text-center">
                                <div class="link">
                                    <p>Don't have an account? <a href="driver_register.php" style="color: #78b144;">REGISTER NOW</a></p>
                                </div>
                                <div class="form-group text-center">
                                </div>
                            </div>
                        ...
                        <script>
                            function isValid() {
                                var driveremail = document.getElementById('email').value;
                                var pass = document.getElementById('pass').value;

                                if (driveremail.length === 0 && pass.length === 0) {
